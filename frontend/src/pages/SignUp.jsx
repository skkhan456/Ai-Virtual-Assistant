    ...
    >
      ...
      >
        ...
        <input
          type="text"
          placeholder="Name"
          className="w-full h-[50px] text-[15px] text-white outline-none border-2 border-white rounded-full p-3 px-[15px] py-[8px] mb-[25px] bg-transparent"
          onChange={(e) => {
        ...
        {err.length>0 && <p className="text-red-500 text-[14px] mb-4">*{err}</p>}

        <button className="w-[200px] h-[50px] bg-blue-500 text-white rounded-full font-bold mb-[20px]" disabled={loading}>
